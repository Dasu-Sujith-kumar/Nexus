  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="border-l-4 border-emerald-500 pl-4 mb-8">
        <h2 className="text-2xl font-bold text-slate-200 mb-1">UPLOAD VIDEOS</h2>
        <p className="text-slate-400">Add new videos to your personal archive</p>
      </div>

      {/* AWS S3 Integration Notice */}
      <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-6 mb-8">
        <div className="flex items-start space-x-3">
          <AlertCircle className="w-6 h-6 text-cyan-400 mt-0.5 flex-shrink-0" />
          <div>
            <h3 className="text-cyan-400 font-semibold mb-2">AWS S3 Integration Required</h3>
      ...
      >
        ...
        <label className="bg-gradient-to-r from-cyan-500 to-emerald-500 text-slate-900 px-6 py-3 rounded-lg font-medium hover:shadow-lg hover:shadow-cyan-500/25 transition-all cursor-pointer inline-block">
          Select Files
          <input
            type="file"
            multiple
      ...
      {Object.keys(uploadProgress).length > 0 && (
        <div className="mt-8 bg-slate-800/30 rounded-lg p-6">
          <h4 className="text-lg font-semibold text-slate-200 mb-4">Upload Progress</h4>
      ...
      {/* Upload Instructions */}
      <div className="mt-8 bg-slate-800/30 rounded-lg p-6">
        <h4 className="text-lg font-semibold text-slate-200 mb-4">Upload Guidelines</h4>
