...
export default function VideoCard({ video, onPlay, onToggleFavorite }: VideoCardProps) {
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-slate-700/50 hover:border-cyan-400/50 transition-all duration-300 group">
      {/* Thumbnail */}
      <div className="relative aspect-video bg-slate-700/50 overflow-hidden">
        ...
        <div className="absolute top-3 left-3">
          <span className="bg-emerald-500 text-slate-900 px-2 py-1 rounded-md text-xs font-bold">
            CLASSIFIED
          </span>
        </div>
        ...
        >
          <div className="w-16 h-16 bg-cyan-500 rounded-full flex items-center justify-center transform scale-75 group-hover:scale-100 transition-transform duration-300">
      ...
      {/* Content */}
      <div className="p-4">
        <h3 className="text-lg font-semibold text-slate-200 mb-2 line-clamp-2 group-hover:text-cyan-400 transition-colors">
          {video.title}
        </h3>
        ...
        <div className="flex items-center justify-between text-xs text-slate-500 mb-3">
          ...
          <span className="px-2 py-1 bg-slate-700/50 rounded text-xs font-medium text-cyan-400">
            {video.category}
          </span>
        </div>
